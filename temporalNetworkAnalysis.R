...
##################################
rot1	<- socialData2[socialData2$rotation == 1,]
rot2	<- socialData2[socialData2$rotation == 2,]
rot3	<- socialData2[socialData2$rotation == 3,]
rot4	<- socialData2[socialData2$rotation == 4,]
rot5	<- socialData2[socialData2$rotation == 5,]
rot6	<- socialData2[socialData2$rotation == 6,]

d2grm1	<- createNet(rot1$actor, rot1$subject, rot1$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot1$duration)
d3grm1	<- createNet(rot1$actor, rot1$subject, rot1$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot1$duration)
f2grm1	<- createNet(rot1$actor, rot1$subject, rot1$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot1$duration)
f3grm1	<- createNet(rot1$actor, rot1$subject, rot1$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot1$duration)

d2grm2	<- createNet(rot2$actor, rot2$subject, rot2$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot2$duration)
d3grm2	<- createNet(rot2$actor, rot2$subject, rot2$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot2$duration)
f2grm2	<- createNet(rot2$actor, rot2$subject, rot2$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot2$duration)
f3grm2	<- createNet(rot2$actor, rot2$subject, rot2$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot2$duration)

d2grm3	<- createNet(rot3$actor, rot3$subject, rot3$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot3$duration)
d3grm3	<- createNet(rot3$actor, rot3$subject, rot3$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot3$duration)
f2grm3	<- createNet(rot3$actor, rot3$subject, rot3$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot3$duration)
f3grm3	<- createNet(rot3$actor, rot3$subject, rot3$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot3$duration)

d2grm4	<- createNet(rot4$actor, rot4$subject, rot4$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot4$duration)
d3grm4	<- createNet(rot4$actor, rot4$subject, rot4$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot4$duration)
f2grm4	<- createNet(rot4$actor, rot4$subject, rot4$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot4$duration)
f3grm4	<- createNet(rot4$actor, rot4$subject, rot4$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot4$duration)

d2grm5	<- createNet(rot5$actor, rot5$subject, rot5$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot5$duration)
d3grm5	<- createNet(rot5$actor, rot5$subject, rot5$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot5$duration)
f2grm5	<- createNet(rot5$actor, rot5$subject, rot5$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot5$duration)
f3grm5	<- createNet(rot5$actor, rot5$subject, rot5$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot5$duration)

d2grm6	<- createNet(rot6$actor, rot6$subject, rot6$behavior, 'Play', subjects = diadema2, type = 'duration', durs = rot6$duration)
d3grm6	<- createNet(rot6$actor, rot6$subject, rot6$behavior, 'Play', subjects = diadema3, type = 'duration', durs = rot6$duration)
f2grm6	<- createNet(rot6$actor, rot6$subject, rot6$behavior, 'Play', subjects = fulvus2, type = 'duration', durs = rot6$duration)
f3grm6	<- createNet(rot6$actor, rot6$subject, rot6$behavior, 'Play', subjects = fulvus3, type = 'duration', durs = rot6$duration)
...
layd2	<- layout.fruchterman.reingold(d2nets[[3]])
layd3	<- layout.fruchterman.reingold(d3nets[[3]])
layf2	<- layout.fruchterman.reingold(f2nets[[3]])
layf3	<- layout.fruchterman.reingold(f3nets[[3]])
...
for(i in 1:4){
	...
	for(j in 1:6){
		...
		#print(commStrx)
		plot.igraph(nets[[i]][[j]], layout = lays[[i]], edge.color = 'black', vertex.label = NA, vertex.frame.color = commStrx[[j]]$frameColor,
			vertex.size = 25, edge.arrow.size = 0.35, vertex.color = commStrx[[j]]$nodeColor, edge.width = E(nets[[i]][[j]])$weight/10)
	}
}